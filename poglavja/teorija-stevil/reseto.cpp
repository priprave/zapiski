...
void poisci_prastevila() {
    // V spremenljivki i bomo hranili število, ki ga trenutno
    // obravnavamo začnemo pri 2, ker niti 0 niti 1 nista praštevili
    // Iteriramo samo do korena M
    for (int i = 2; i*i <= M; i++) {
        // Če je na mestu i ničla, do sedaj nismo našli
        // nobenega praštevila, torej mora biti število i
        // nujno praštevilo
        if (reseto[i] == 0) {

...
Na voljo so nam podobne operacije kot pri vrstah: \koda{push(x)} doda \koda{x}
na kopico, \koda{pop()} odstrani največji element iz kopice, \koda{top()} pa
...
\fkoda{poglavja/podatkovne-strukture/kopica.cpp}
...
\fkoda{poglavja/podatkovne-strukture/kopica-najmanjsi.cpp}
